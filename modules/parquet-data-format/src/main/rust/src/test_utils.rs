...
/// Creates FFI data with a schema (Int64, Boolean) that is incompatible
/// with the default writer schema (Int32, Utf8).
...
/// Closes the writer, cleans up the FFI schema, and returns the FileMetaData.
